...
El [proyecto final del curso](../../proyecto_final/enunciado_proyecto_final.html) le pide este pipeline completo sobre la base de innovación empresarial: limpiar (U2), describir y graficar (U3), estimar e interpretar una regresión sencilla (U4), todo dentro de un proyecto ordenado (U1) que se sustenta oralmente.
:::
