...
```{=html}
<details class="answer"><summary>Ver respuesta</summary>
<p><b>No.</b> El (a) es casi con certeza un <b>error de captura</b> (probablemente $120, con un cero de más): se corrige y se documenta. El (b) puede ser perfectamente <b>real</b>: el cliente corporativo más grande del año. Si lo eliminas "para limpiar", borraste el dato más valioso de la base. La regla: <b>el mismo procedimiento estadístico marca a los dos, pero solo el conocimiento del negocio los distingue</b>. Un outlier no es un error hasta que demuestres que lo es — así que ve a mirar la fila completa antes de decidir.</p>
</details>
```
:::
