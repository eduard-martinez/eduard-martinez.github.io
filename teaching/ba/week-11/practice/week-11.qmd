...
|---|---|---|
| Fila "Aprobado", Col "Aprobado" | **VP** | Predijo Aprobado y era Aprobado — acierto |
...
| Fila "Rechazado", Col "Rechazado" | **VN** | Predijo Rechazado y era Rechazado — acierto |
...
VP <- tabla_confusion["Aprobado",  "Aprobado"]   # real Aprobado, pred Aprobado
...
VN <- tabla_confusion["Rechazado", "Rechazado"]  # real Rechazado, pred Rechazado
```
...
Durante el semestre, el equipo de analítica de una entidad financiera evaluó un árbol de clasificación entrenado para predecir si una solicitud de crédito debía aprobarse o rechazarse. El modelo fue probado sobre 40 solicitudes del conjunto de prueba, de las cuales 22 eran realmente aprobadas y 18 eran realmente rechazadas.
De las 22 solicitudes que realmente debían aprobarse, el modelo identificó correctamente 18 y clasificó erróneamente 4 como rechazadas. De las 18 solicitudes que realmente debían rechazarse, el modelo clasificó correctamente 14 como rechazadas, pero aprobó incorrectamente las 4 restantes.

::: {.callout-practice}
**Actividad en clase — Entrega individual**

Con los resultados del texto anterior, completa esta tabla a mano en un documento word y cargalo en Intu en el espacio indicado por el profesor.
...
|---|---|---|
| **Real: Aprobado** | VP = _____ | FN = _____ |
| **Real: Rechazado** | FP = _____ | VN = _____ |
