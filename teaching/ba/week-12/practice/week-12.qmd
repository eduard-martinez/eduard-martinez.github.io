...
text(arbol, use.n = TRUE, cex = 0.75)
```
...
## Imprimir / Print
cat("MAE en test:", round(MAE_test, 3), "\n")
cat("Interpretación: en promedio, el modelo se equivoca por",
    round(MAE_test, 3), "puntos en la nota final\n")
```
...
cat("MAE en train:", round(MAE_train, 3), "\n")
cat("MAE en test: ", round(MAE_test,  3), "\n")
```
...
cat("RMSE en test:", round(RMSE_test, 3), "\n")
cat("MAE  en test:", round(MAE_test,  3), "\n")
cat("Diferencia:  ", round(RMSE_test - MAE_test, 3),
    "— cuánto pesan los errores grandes\n")
```
...
cat("MAE baseline:", round(MAE_baseline, 3), "\n")
cat("MAE árbol:   ", round(MAE_test,     3), "\n")
cat("Mejora:      ", round(MAE_baseline - MAE_test, 3),
    "puntos menos de error\n")
cat("Reducción:   ", round((1 - MAE_test/MAE_baseline)*100, 1),
