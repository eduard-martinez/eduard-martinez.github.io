...
1. 🎧 **Escucha el episodio** — saldrá en el podcast del curso en Spotify: [*El Dato con Contexto*](https://open.spotify.com/show/033UvL50nPzm1gIH35udu5). <!-- TODO: pegar aquí el enlace directo del episodio cuando se publique -->
...
4. ✅ **Presenta el quiz** — escrito, en papel, al inicio de la clase (cubre el podcast **y** los videos).
:::
