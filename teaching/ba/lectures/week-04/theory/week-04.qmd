...
subtitle: "Analítica para los negocios · Semana 4 · 06327-ECO"
...
1. 🎬 **Ve los dos videos de la semana** — están embebidos aquí abajo: [parte 1, el verbo a verbo de `dplyr`](https://youtu.be/MVNvoBbELKs){target="_blank"} y [parte 2, la construcción de gráficos por capas con `ggplot2`](https://youtu.be/sCfhUTHA4fQ){target="_blank"}.
...
{{< video https://youtu.be/MVNvoBbELKs >}}

**Parte 2 — Visualización con `ggplot2`:**

{{< video https://youtu.be/sCfhUTHA4fQ >}}
